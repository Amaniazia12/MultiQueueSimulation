...
namespace MultiQueueModels
{
    public class SimulationSystem
    {
        ...
        public void read_from_file()
        {
            ...
            FileStream fs = new FileStream(@"F:\lectcures and labs fourth year\1st term\Modeling and Simulation\assignments\task 1\task 1_updated\Task 1\Template_Students\MultiQueueSimulation\MultiQueueSimulation\TestCases\TestCase2.txt", FileMode.Open);
      ...
      public void set_time_distripution_table_servers()
      {
        ...
        public void _SimulationCase()
        {
            ...
            for (int i = 0; i <count ; i++)
            {
                ...
                totalSysServiceTime += sc.ServiceTime;
            ...
            for(int i = 0; i < Servers.Count; i++)
            {
                ...
                {
                    if (i == SimulationTable[j].AssignedServer.ID)
                    {
                        if (check)
                        {
                ...
                Servers[i]._AverageServiceTime(Servers[i].TotalWorkingTime, SimulationTable.Count);
