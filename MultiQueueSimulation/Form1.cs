...
namespace MultiQueueSimulation
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
               ...
               sm._SimulationCase();
               sm.set_performance();
               MessageBox.Show("AverageWaitingTime " + sm.PerformanceMeasures.AverageWaitingTime.ToString());
               //per.MaxQueueLength = PerformanceMeasures.leng;
               //per.SetAverageWaitingTime(SimulationSystem.totalWaitingTime, sm.SimulationTable.Count);
               // per.SetWaitingProbability(SimulationSystem.NumOfCustomerWhoWaited, sm.SimulationTable.Count);
